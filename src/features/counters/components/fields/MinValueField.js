...
export default function MinValueField({ control = defaultProps.control } = {}) {
  const theme = useTheme();

  return renderMinValueField({
    control,
    theme,
  });
}

const renderMinValueField = ({ control, theme }) => (
  <Controller
    control={control}
    name="minValue"
...
const renderFieldContent = ({ value, onChange, theme }) => (
  <View style={getContainerStyle()}>
    <Text style={getLabelStyle(theme)}>Min Value (optional)</Text>
